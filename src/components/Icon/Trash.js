...
const Trash = ({ size = 23, filled = false, color = "currentColor", strokeWidth = "2", style, ...props }) => (
  <svg className="trash-icon" viewBox="0 0 15 15" strokeLinecap="square" strokeLinejoin="square" width={size} height={size} style={{ display: "block", ...style }} xmlns="http://www.w3.org/2000/svg" {...props}>
    <g>
